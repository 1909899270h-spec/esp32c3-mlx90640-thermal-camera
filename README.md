...
仓库的 `deliverables/` 目录中保留了课程展示相关文件：

| 文件 | 说明 |
| --- | --- |
| `基于ESP32-C3与MLX90640的热成像相机系统设计_答辩PPT.pptx` | 期末大作业展示 PPT |
| `基于ESP32-C3与MLX90640的热成像相机系统开发流程.docx` | 项目开发流程 Word 文档 |
| `基于ESP32-C3与MLX90640的热成像相机系统开发流程.pdf` | 项目开发流程 PDF 文档 |
| `build_development_process_doc.py` | 开发流程文档生成脚本 |
